  ...
  'how-far-do-asx-shares-fall': () => (
    <>
      <p>
        ...
        company&rsquo;s worst fall runs to <strong>85%</strong>. That{' '}
      ...
      <p>
        ...
        that America&rsquo;s six greatest wealth creators, Apple and Microsoft and
      ...
      <ul>
        <li>
          A fall is measured from the company&rsquo;s highest point in the previous
      ...
      <p>
        ...
        Canada&rsquo;s largest companies; the ASX 200 holds two hundred, reaching much
      ...
      />
      <p>
        The gap does not narrow. It <strong>reverses.</strong> Australia&rsquo;s sixty
        biggest listed companies have fallen slightly less than America&rsquo;s sixty
        biggest.
      </p>
      <p>
      ...
      <h3>The one row that is not comparing the same thing</h3>
      <p>
      ...
      <p>
        It also explains the Energy row above. Three of Australia&rsquo;s coal miners
        and three of its uranium companies sit there rather than in Basic Materials,
        which is why that row runs deeper than America&rsquo;s too.
      </p>
      ...
      <p>
        ...
        the pure-play producers beneath them. &ldquo;Mining is volatile&rdquo; is true
      ...
      <p>
        ...
        <strong>Westpac&rsquo;s came in March 2020</strong>, in the COVID crash — the
        worst moment in a company&rsquo;s history is not always the one you would
        guess.
      </p>
      <p>
      ...
      <p>
        ...
        <Link href="/learn/own-history-vs-market-average">
          why a company&rsquo;s own history beats the market average
        </Link>
        .
      </p>
    </>
