...
> - **Pending owner steps:** delete the old Seoul project after a few stable days; enable Email + Google auth providers on the new project; update local `.env.local` to the new project keys.
